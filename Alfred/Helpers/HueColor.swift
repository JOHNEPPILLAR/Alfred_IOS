...
//  Alfred
//
//  Created by John Pillar on 19/07/2020.
...
public struct HueColorHelper {

    static let cptRED = 0
    static let cptGREEN = 1
    static let cptBLUE = 2

    public static func getColorFromScene(_ scene: Int) -> UIColor {
        switch scene {
    ...
    /**
     ...
     - model: model of the lamp, example: "LCT001" for hue bulb. Used to calculate the color gamut.
