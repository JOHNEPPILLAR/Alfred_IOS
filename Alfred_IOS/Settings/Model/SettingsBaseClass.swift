...
public final class SettingsBaseClass: NSCoding {
  ...
  public required init(json: JSON) {
    data = SettingsData(json: json[SerializationKeys.data])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.data = aDecoder.decodeObject(forKey: SerializationKeys.data) as? SettingsData
