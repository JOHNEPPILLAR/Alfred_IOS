//
//  InsideWeatherInsideWeatherBaseClass.swift
//
...
public final class InsideWeatherBaseClass: NSCoding {
  ...
  // MARK: Properties
  public var data: InsideWeatherData?
  ...
  public required init(json: JSON) {
    data = InsideWeatherData(json: json[SerializationKeys.data])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.data = aDecoder.decodeObject(forKey: SerializationKeys.data) as? InsideWeatherData
