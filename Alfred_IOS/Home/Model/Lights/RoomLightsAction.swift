...
public final class RoomLightsAction: NSCoding {
  ...
  // MARK: Properties
  public var attributes: RoomLightsActionAttributes?
  ...
  public required init(json: JSON) {
    attributes = RoomLightsActionAttributes(json: json[SerializationKeys.attributes])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.attributes = aDecoder.decodeObject(forKey: SerializationKeys.attributes) as? RoomLightsActionAttributes
